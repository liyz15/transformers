...
# PATCHED STARTED BY Yizhuo
# This is because the tokenizer and the model has different set of ids for
TOKENS_TO_SWITCH = [
    ("<sep>", "<|extra_31|>"),
    ("<vid>", "<|extra_32|>"),
    ("</vid>", "<|extra_33|>"),
...
for token1, token2 in TOKENS_TO_SWITCH:
    ...
    SPECIAL_TOKENS[idx1 - SPECIAL_START_ID] = (
        idx1, 
        token2
    )
    SPECIAL_TOKENS[idx2 - SPECIAL_START_ID] = (
        idx2,
        token1
    )
# PATCHED ENDED
...
class ARCHunyuanVideoTokenizer(PreTrainedTokenizer):
    """hunyuan tokenizer."""
...
__all__ = ["ARCHunyuanVideoTokenizer"]
